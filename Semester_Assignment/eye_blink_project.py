    ...
    while True:
        ...
        try:
            ...
            if faces:
                ...
                # We want to measure the distance between the eye top and bottom points
                ...
                # We are checking the horizontal distance between the eyes (for l_ratio calculation against the movement problem)
                ...
                # print(f'l hist rat: {left_eye_ratio * threshold} vs l mean: {l_ratio_mean} | r hist rat: {right_eye_ratio * threshold} vs r mean: {r_ratio_mean}')

                print(f'Left area {LeftEyeArea(faces)} | Right area {RightEyeArea(faces)}')
                print(f'blinkCounter: {blinkCounter}')
...
def LeftEyeArea(faces):
    ...
    # print(f'L area: {left_eye_points_area}')
...
def RightEyeArea(faces):
    ...
    # print(f'R area: {right_eye_points_area}')
